...
<Tip>
  [**Read our quickstart guide to set up mogenius and get started.**](./../overview/quickstart.md)

  [**Or dive into how mogenius works for a comprehensive overview.**](../overview/how-mogenius-works.md)
</Tip>
