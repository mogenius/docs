...
- **Form-based Editing**: For custom resources that have a [Custom Resource Form](/cluster-management/ui-configs) configured, a **Details** tab renders a structured form with labelled inputs and validation instead of raw YAML.
...
- **Tunnels**: For Services, create secure TCP tunnels to access internal services from your local machine without direct cluster access. See [Tunnels](/workspaces/tunnels) for details.